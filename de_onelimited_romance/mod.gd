...
var unflag_romance: Reference = preload("res://mods/de_onelimited_romance/uncheck_romanced.gd").new()

func _init():
	TranslationServer.add_translation(preload("onelimited_strings.en.translation"))
